 ...
 * 아이콘은 emoji 대신 StatusIcons 컴포넌트(CheckCircleIcon 등)를 tone으로 골라 쓴다.
 */
// partial은 백엔드에서 "미충족은 없으나 정보 부족(unknown) 조건이 있는" 경우만 반환한다.
export const ELIGIBILITY_STATUS = {
    eligible:   { label: "신청 대상이에요",       tone: "eligible" },
    partial:    { label: "일부 조건을 확인할 수 없어요", tone: "partial" },
    ineligible: { label: "신청 대상이 아니에요",   tone: "ineligible" },
};
