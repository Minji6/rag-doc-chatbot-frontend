 ...
 *
 * ⚠️ 한계: "### 정책명" 헤더 형식에만 의존한다. LLM이 응답 포맷을 바꾸면
 * (## 헤더 / 번호 목록 / 볼드 텍스트 등) 정책 블록을 못 잡고 policies: []를
 * 조용히 반환한다. 이 경우 BotMessage가 hasPolicyBlocks(=false)로 판단해
 * 카드 대신 ReactMarkdown 일반 텍스트로 fallback 렌더한다.
 */
